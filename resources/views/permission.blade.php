    ...
    <body>
     ...
     <div class="card-body">
      <form method="POST" action="http://metrorail.local:8000/permit/user">
        ...
        @if($value!='show_info' && $value=='Permitted Access!')
         <script type="text/javascript">alert("mail sent to user with user_id");</script>
           @endif

       
        @if($value!='show_info')
          <p> <h4  class="animated infinite bounce" style="margin-left:600px;margin-top:50px"> 
          {{$value}} </h4> </p>
           @endif
